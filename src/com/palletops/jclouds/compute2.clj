...
(ns com.palletops.jclouds.compute2
 ...
 Current supported providers are available via the following dependency:
  com.palletops.jclouds/jclouds-allcompute

 You can inquire about which providers are loaded via the following:
  (seq (com.palletops.jclouds.providers.Providers/allCompute))
  (seq (com.palletops.jclouds.apis.Apis/allCompute))

Here's an example of getting some compute configuration from rackspace:

  (use 'com.palletops.jclouds.compute2)
  (use 'clojure.pprint)
